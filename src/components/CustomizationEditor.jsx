...
import { Palette, Type, Layout, Sliders, Eye } from 'lucide-react'
...
export default function CustomizationEditor({ resumeData, setResumeData }) {
  ...
  return (
    <div className="border-2 border-blue-200 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 shadow-sm overflow-hidden">
      {/* Header */}
